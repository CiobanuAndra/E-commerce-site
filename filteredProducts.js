...
const filterListByTitleFromLocalStorage = localStorage.getItem('filterListByTitleLocalStorage')
const filterListByTitle = JSON.parse(filterListByTitleFromLocalStorage);
...
createPages(filterListByTitle);
createProductsList(0,filterListByTitle);
